...
## Uninstalling  
Inside the **scripts folder** where the install.sh script is, there is an **unistall.sh** and **reinstall.sh**, just make sure you are in the **project directory** (where the build directory is but not inside it) **or** inside the **scripts's directory**, otherwise it won't succesfully unistall everything.
